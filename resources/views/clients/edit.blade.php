            ...
            <div class="card my-4" style="background: #9ADCFF;">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class=" shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-content-center"
                        ...
                        <h3 class="text-white  text-capitalize ps-3"> <i>Editar cliente: "{{ $client->name }}
                                {{ $client->lastname }}"</i></h3>
                    </div>
                </div>
                <div class="">
                    {{-- Inicio Formulario --}}
                    <form action="{{ url('/clients/' . $client->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            ...
                            <input style="background: white" type="text" class="form-control" id="name"
                                name="name" minlength="4" value="{{ $client->name }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input style="background: white" type="text" class="form-control" id="lastname"
                                name="lastname" minlength="4" value="{{ $client->lastname }}" required>
                            <div class="valid-feedback text-white">
                                Buen apellido!
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            ...
                            <img style="height: 80px; border-radius:5px"
                                src="{{ asset('storage') . '/' . $client->image }}" alt="imagen">
                        ...
                        <div class="col-md-3">
                            <label for="inputZip" class="form-label text-white"><b>Direccion</b> </label><br>
                            <input style="background: white" type="text" class="form-control" id="home_address"
                                name="home_address" minlength="5" value="{{ $client->home_address }}" required>
                            <div class="valid-feedback text-white">
                                Muy buena zona!
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            ...
                            <input style="background: white" type="password" class="form-control" id="password"
                                name="password" minlength="8" maxlength="20" value="{{ $client->password }}"
                                required>
                            <div class="valid-feedback text-white">
