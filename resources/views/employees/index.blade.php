                                    ...
                                    <tr class="tabla text-center">
                                        <td>
                                            <span class="text-secondary text-xs font-weight-bold"><img
                                                    ...
                                                    src="{{ asset('storage') . '/' . $employe->image }}"
                                                    alt="imagen"></span>
                                        </td>
                                        <td>
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $employe->id }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $employe->name }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $employe->lastname }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $employe->email }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $employe->password }}</span>
                                        </td>
                                        <td class="align-middle align-content-center  ">
                                            <a class="text-secondary font-weidght-bol text-xs enlace btn barra"
                                                href="{{ url('/employees/' . $employe->id . '/edit') }}">
                                                <img style="height: 20px; opacity: .6"
                                                    src="{{ asset('img/editar.png') }}" alt="">
                                            </a>
                                            <form class="d-inline" action="{{ url('/employees/' . $employe->id) }}"
                                                method="post">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                                <button
