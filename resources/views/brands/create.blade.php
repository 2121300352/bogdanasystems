@include('include.head')
  <aside style="background-color:  #FF8AAE;" class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    ...
    <div class="col-12">
      <div class="card my-4" style="background: #9ADCFF;">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class=" shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-content-center" style="background-color:  #FF8AAE;">
            <h3 class="text-white  text-capitalize ps-3"> <i>Agregar Nueva Marca</i></h3>
          </div>
        </div>
        <div class="">
            {{-- Inicio Formulario --}}
            <form action="{{url ('/brands')}}" method="post" enctype="multipart/form-data" class="row g-3 row g-3 needs-validation" novalidate style="margin: 10px;">
              @csrf  
              <div class="col-md-6">
                    <label class="form-label text-white"><b>Nombre</b></label>
                    <input style="background: white" type="text" class="form-control" id="name" name="name" minlength="4" required>
                ...
                <div class="col-md-6">
                    ...
                    <input style="background: white" type="text" class="form-control" id="description" name="description" minlength="10" required>
                    <div class="valid-feedback text-white">
                ...
                <div class="col-md-2">
                    <label for="inputZip" class="form-label text-white"><b>Logotipo</b> </label><br>
                    <input style="background: white" type="file" class="form-control" id="logo" name="logo" value="" required>
                    <div class="valid-feedback text-white">
                        Buena foto!!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-12 text-center">
                    <button type="submit" class="btn barra text-white" style="background: #FF8AAE">Enviar</button>
                </div>
            </form>
            {{-- Fin Formulario --}}
