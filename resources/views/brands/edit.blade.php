            ...
            <div class="card my-4" style="background: #9ADCFF;">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class=" shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-content-center"
                        ...
                        <h3 class="text-white  text-capitalize ps-3"> <i>Editar Marca:"{{ $brand->name }}"</i></h3>
                    </div>
                </div>
                <div class="">
                    {{-- Inicio Formulario --}}
                    <form action="{{url ('/brands/'.$brand->id)}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            ...
                            <input style="background: white" value="{{ $brand->name }}" type="text"
                                class="form-control" id="name" name="name" minlength="4" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input style="background: white" value="{{ $brand->description }}" type="text"
                                class="form-control" id="description" name="description" minlength="10" required>
                            <div class="valid-feedback text-white">
                        ...
                        <div class="col-md-2">
                            ...
                            <img style="height: 80px; border-radius:5px"
                                src="{{ asset('storage') . '/' . $brand->logo }}" alt="imagen">
                            <input style="background: white" type="file"
                                class="form-control" id="logo" name="logo" value="{{$brand->logo }}">
                            <div class="valid-feedback text-white">
                                Buena foto!!
                            </div>
                            <div class="invalid-feedback">
