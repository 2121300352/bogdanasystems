...
<aside style="background-color:  #FF8AAE;"
    ...
    <div class="" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="barra">
                <a class="nav-link text-white active" style="background: #9ADCFF;" href="{{ url('products') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
            ...
            <div class="card my-4" style="background: #9ADCFF;">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class=" shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-content-center"
                        ...
                        <h3 class="text-white  text-capitalize ps-3"> <i>Editar Producto: "{{ $product->name }}"</i>
                        </h3>
                    </div>
                </div>
                <div class="">
                    ...
                    <form action="{{url ('/products/'.$product->id)}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6">
                            ...
                            <input style="background: white" type="text" class="form-control" id="name"
                                name="name" minlength="4" value="{{ $product->name }}" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input style="background: white" type="text" class="form-control" id="description"
                                name="description" minlength="10" value="{{ $product->description }}" required>
                            <div class="valid-feedback text-white">
                        ...
                        <div class="col-md-4">
                            ...
                            <img style="height: 80px; border-radius:5px"
                                src="{{ asset('storage') . '/' . $product->image }}" alt="imagen">
                        ...
                        <div class="col-md-2">
                            ...
                            <input style="background: white" type="tel" class="form-control" id="price"
                                name="price" minlength="1" maxlength="2" value="{{ $product->price }}"
                                required>
                            <div class="valid-feedback text-white">
                                Que baratoo!!
                            </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input style="background: white" type="tel" class="form-control" id="stock"
                                name="stock" minlength="1" maxlength="2" value="{{ $product->stock }}"
                                required>
                            <div class="valid-feedback text-white">
                                Tantooos?!!
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select style="background: white" id="inputState" class="form-select" id="brand_id"
