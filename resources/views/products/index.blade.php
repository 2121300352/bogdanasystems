            ...
            <div class="card my-4" style="background: #9ADCFF;">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class=" shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-content-center"
                        ...
                        <h3 class="text-white  text-capitalize ps-3"> <i>P r o d u c t o s</i></h3> <a
                            style="height: 50px" class="btn barra" href="{{ url('products/create') }}"> <img
                            ...
                            <tbody>
                                ...
                                @foreach ($products as $product)
                                    <tr class="tabla text-center">
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $product->brand->name }}</span>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <span
                                        ...
                                        <td class="align-middle align-content-center  ">
                                            ...
                                            <form class="d-inline" action="{{ url('/products/' . $product->id) }}"
                                                method="post">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                                <button
